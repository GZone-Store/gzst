function lineLogin() {
  ...
  const redirectUri = encodeURIComponent('https://gzonelineloginio.glitch.me/callback');
  const state = encodeURIComponent(location.origin + location.pathname);
...
window.onload = function () {
  ...
  if (name && email) {
    ...
    if (picture) document.getElementById("accountProfileImage").src = decodeURIComponent(picture);
